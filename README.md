...
- [Exclude Patterns](https://github.com/maarc/csa/blob/master/doc/CSA-UserManual.md#rules) - To help with fighting false positives
- [Profiles](https://github.com/maarc/csa/blob/master/doc/CSA-UserManual.md#rules) - To help select what type of rules to be used during scanning
- [Rule Testing Framework](https://github.com/maarc/csa/blob/master/doc/CSA-UserManual.md#rule-testing-framework) - To help with testing CSA rules against real code samples
- [Generate HTML and CSV Finding Reports](https://github.com/maarc/csa/blob/master/doc/CSA-UserManual.md#generate-html-and-csv-reports) - Generate HTML and CSV Reports that can be leveraged into a CI pipeline
...
The cloud-suitability-analyzer project team welcomes contributions from the community.

## License

Cloud Suitability Analyzer is released under the BSD-2 license. Please see [LICENSE.txt](https://github.com/maarc/csa/blob/master/LICENSE.txt)
